                ...
                <div class="widget am-cf">
                    ...
                    <div class="widget-body am-fr">
                        ...
                        <form class="am-form tpl-form-border-form tpl-form-border-br" method="post"
                              action="<?php echo U('Admin/Category/edit');?>/id/<?php echo ($category["id"]); ?>">
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">分类名称:</label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="category_name"
                                           placeholder="请输入分类名称" value="<?php echo ($category["category_name"]); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="tpl-switch">
                                        <?php if(($category["display_status"] == 1)): ?><input type="checkbox" class="ios-switch bigswitch tpl-switch-btn" checked="" name="display_status">
                                            <?php else: ?>
                                            <input type="checkbox" class="ios-switch bigswitch tpl-switch-btn"  name="display_status"><?php endif; ?>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="5"
                                              placeholder="请输入文章内容" name="category_description"><?php echo ($category["category_description"]); ?></textarea>
                                </div>
                            </div>
